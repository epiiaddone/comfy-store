## Overview
udemy - Complete React, Next.js & TypeScript Projects Course 2025

section 15 - Comfy Store
React Router 6.4+
RTK
Axios
React Query
...
- add tailwind - V4 - tailwind.config.js is optional

```sh
npm install -D tailwindcss postcss autoprefixer (postcss not required for V4)
npm install -D @tailwindcss/cli  (tailwind V4 the cli is split into a seperate module) - 	EXTRA STEP in V4
npm install -D @tailwindcss/vite  (extra step in V4)
npx tailwindcss init -p (init removed from tailwind 4+) CANT DO THIS STEP
```

- rename to tailwind.config.cjs
- add following content

tailwind.config.cjs - optional in tailwind V4+
...
```css - these are not necessary in tailwind V4+
@tailwind base;
@tailwind components;
@tailwind utilities;
```
...
## Challenge (2) - Setup DaisyUI
 ...
 -------------------------
 built upon tailwind - add additional tailwind classes 
easier than bootstrap - harder to modify as need to understand the existing css
...
this makes setting up themes easy
------------------------
...
tailwind.config.js - not necessary in V4+
instead:
```css
@import "tailwindcss";
